...
// converting graphb from file to adjacecncy list
...
int main(int argc, char** argv) {
    ...
    //Read and partition graph on rank 0 
    int n;
    ...
    // --- 8) Reduce final Dist and Parent to rank 0 ---
